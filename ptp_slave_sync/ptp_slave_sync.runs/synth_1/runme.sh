...
HD_PWD='/home/dallas0/github/ptp-slave-sync-ip/ptp_slave_sync/ptp_slave_sync.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ptp_sync_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ptp_sync_wrapper.tcl
